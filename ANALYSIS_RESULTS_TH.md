...
## อัปเดต v0.5.0 — แสดงตำแหน่งชื่อ CAD ซ้ำบนกราฟิก

โปรแกรมสร้างกลุ่มชื่อซ้ำจาก `cadName` ใน CAD XML ภายใน Component/Part ที่กำลังเลือก ไม่รวมชื่อเดียวกันที่อยู่คนละ Part เข้าด้วยกัน

- วงแหวนสีชมพู: Land ที่ชื่อ CAD ซ้ำ
- วงแหวนสีเหลืองและเส้นประ: ทุกตำแหน่งของชื่อซ้ำที่กำลังเลือก
- รายการด้านขวา: XML global ID, X-ray local Land (ถ้ามีในข้อมูลดิบ) และพิกัด X/Y
- เมนูด้านซ้าย: เลือกชื่อซ้ำและ Fit ทุกตำแหน่ง
- โหมด Dim others: ลดความเด่นของ Land ที่ชื่อไม่ซ้ำ

สำหรับ U1 ในไฟล์ตัวอย่าง ระบบพบ 1,169 กลุ่มชื่อซ้ำ รวม 2,338 ตำแหน่ง และจะแสดงเฉพาะภายใน U1 เพราะข้อมูลดิบมีเพียง Part U1
